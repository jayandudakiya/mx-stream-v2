...
interface AnimeSource {
     ...
     *
     * Default implementation returns [listOf(anime)], meaning the source has no multi-season
     * navigation and episodes are resolved directly via [getEpisodeList]. Mainstream v16
     * extensions that do not support seasons do not override this — keeping it abstract would
     * cause AbstractMethodError at runtime on every such extension.
     *
     * Sources that DO support multiple seasons override this and return one [SAnime] per season.
     *
     * @since extensions-lib 16
     * @param anime the anime to fetch seasons for.
     * @return the anime list for the anime; defaults to [listOf(anime)].
     */
    suspend fun getSeasonList(anime: SAnime): List<SAnime> = listOf(anime)
