 ...
 * for host-side JSON serialisation in the OrcaBox app.
 */
 ...
 *
 * Structural twin of [com.orcabox.app.aniyomi.AniyomiJson] for the manga
...
object MihonJson {
     ...
     * than inside it, same as [com.orcabox.app.aniyomi.AniyomiJson] does
