 ...
 *
 * Channel `com.orcabox.app/torrent_download`:
...
class TorrentDownloadEngine(
    ...
    private val method = MethodChannel(messenger, "com.orcabox.app/torrent_download")
    private val events = EventChannel(messenger, "com.orcabox.app/torrent_download/events")
