package com.orcabox.app.cast

import android.app.Activity
import android.util.Log
import com.orcabox.app.R
...
/**
 * Wraps the Google Cast SDK for Flutter via the `orcabox/cast` MethodChannel
 * and a `orcabox/cast/events` EventChannel.
 *
