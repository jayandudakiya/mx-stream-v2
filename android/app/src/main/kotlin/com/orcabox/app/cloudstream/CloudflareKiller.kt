...
class CloudflareKiller : Interceptor {
    ...
    fun getCookieHeaders(url: String): okhttp3.Headers {
        ...
        com.orcabox.app.cloudstream.CfClearance.userAgent
    ...
    override fun intercept(chain: Interceptor.Chain): Response {
        ...
        if (com.orcabox.app.cloudstream.CfClearance.searchDepth.get() > 0) return response
        ...
        synchronized(locks.getOrPut(finalHost) { Any() }) {
            if (!cookieByHost.containsKey(finalHost)) {
                ...
                com.orcabox.app.cloudstream.CfClearance.userAgent = solved.userAgent
            }
        }
        response.close()
        ...
        val retried = request.newBuilder()
            ...
            .apply {
                ...
                com.orcabox.app.cloudstream.CfClearance.userAgent?.let { header("User-Agent", it) }
            }
            .build()
    ...
    private fun applySaved(request: Request, host: String): Request {
        ...
        com.orcabox.app.cloudstream.CfClearance.userAgent?.let { b.header("User-Agent", it) }
        return b.build()
    }
...
internal object CfWebViewSolver {
    ...
    fun solve(url: String): Result? {
        ...
        val activity = com.orcabox.app.MainActivity.current?.get()
        ...
        fun captureIfReady() {
            ...
            if (cookie != null) {
                ...
                if (ua.isNotEmpty()) com.orcabox.app.cloudstream.CfClearance.userAgent = ua
