 ...
 */
package com.orcabox.app.aniyomi
 ...
 *                              `"orcabox_aniyomi"` so all Aniyomi state is in one
 *                              named file
 */
        ...
        synchronized(this) {
            ...
            val extensionClient: OkHttpClient = shared.newBuilder()
                .apply {
                    networkInterceptors().removeAll {
                        it === com.orcabox.app.cloudstream.CfClearance.interceptor
                    }
                }
                .build()
            ...
            Injekt.importModule(object : InjektModule {
                ...
                override fun InjektRegistrar.registerInjectables() {
                    ...
                    addSingleton(
                        SourcePreferences(
                            app.getSharedPreferences("orcabox_aniyomi", Context.MODE_PRIVATE),
                        ),
                    )
                }
            })
