 ...
 *
 * Channel protocol (com.orcabox.app/torrent):
 *   startStream {uri}       -> {id, localUrl}   (returns once head-buffered)
 *   stopStream  {id}        -> null
 * Events (com.orcabox.app/torrent/events):
...
class TorrentEngine(
    ...
    private val method = MethodChannel(messenger, "com.orcabox.app/torrent")
    private val events = EventChannel(messenger, "com.orcabox.app/torrent/events")
