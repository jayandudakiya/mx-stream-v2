...
ProviderType sourceTypeOf(String id) {
  ...
  // Native movie providers (VegaMovies/RogMovies) are movie-only by
  // construction — no manifest, no GetIt lookup needed, same reasoning as
  // the `mihon:`/`lnr:` lines above.
  if (id.startsWith('native:')) return ProviderType.movie;
