...
part 'orcabox_sources_screen_phone.dart';
part 'orcabox_sources_screen_tv.dart';

/// Dedicated OrcaBox (JS provider) ecosystem screen — Installed and
...
class OrcaBoxSourcesScreen extends StatelessWidget {
  const OrcaBoxSourcesScreen({
    super.key,
  ...
  /// Defaults to false so every other call site (the existing OrcaBox row,
