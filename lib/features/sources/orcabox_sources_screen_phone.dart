// OrcaBox sources — phone UI.
part of 'orcabox_sources_screen.dart';
...
class _ZPhoneView extends StatefulWidget {
  ...
  /// See [OrcaBoxSourcesScreen.openToRepos].
  final bool openToRepos;

  /// See [OrcaBoxSourcesScreen.scopeToReading].
...
class _ZPhoneViewState extends State<_ZPhoneView> {
  ...
  /// when [OrcaBoxSourcesScreen.scopeToReading] is true; irrelevant (and
