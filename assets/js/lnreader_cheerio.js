(() => {
  ...
  var init_shim = __esm({
    "shim.mjs"() {
      ...
      if (!globalThis.process) globalThis.process = { env: {}, nextTick: function(f) {
        Promise.resolve().then(f);
      } };
      globalThis.global = globalThis;
      if (!globalThis.atob) globalThis.atob = function(b64) {
        return import_buffer.Buffer.from(String(b64), "base64").toString("binary");
      };
      ...
      if (!globalThis.URL) {
        globalThis.URL = function URL2(url, base) {
          ...
          if (base && !/^[a-z][a-z0-9+.-]*:\/\//i.test(u)) {
            var b = String(base);
            var root2 = (b.match(/^([a-z]+:\/\/[^\/]+)/i) || [b])[0];
            if (u.charAt(0) === "/") u = root2 + u;
            else u = b.replace(/\/[^\/]*$/, "/") + u;
          }
      ...
      if (!globalThis.URLSearchParams) {
        globalThis.URLSearchParams = function URLSearchParams(init) {
          ...
          if (typeof init === "string") {
            init.replace(/^\?/, "").split("&").forEach(function(pair) {
              ...
              self2._p.push([decodeURIComponent(k), decodeURIComponent(v.replace(/\+/g, " "))]);
            });
          } else if (init && typeof init === "object") {
            Object.keys(init).forEach(function(k) {
              self2._p.push([k, String(init[k])]);
            });
          }
        };
        P = globalThis.URLSearchParams.prototype;
        ...
        P.getAll = function(k) {
          return this._p.filter(function(x) {
            return x[0] === k;
          }).map(function(x) {
            return x[1];
          });
        ...
        P.delete = function(k) {
          this._p = this._p.filter(function(x) {
            return x[0] !== k;
          });
        };
        P.forEach = function(cb) {
          this._p.forEach(function(x) {
            cb(x[1], x[0]);
          });
        };
        P.toString = function() {
  ...
  // node_modules/cheerio/node_modules/htmlparser2/dist/esm/index.js
  init_shim();

  // node_modules/cheerio/node_modules/htmlparser2/dist/esm/Parser.js
  init_shim();

  // node_modules/cheerio/node_modules/htmlparser2/dist/esm/Tokenizer.js
  init_shim();

  // node_modules/cheerio/node_modules/entities/dist/esm/decode.js
  init_shim();

  // node_modules/cheerio/node_modules/entities/dist/esm/decode-codepoint.js
  init_shim();
  var _a2;
  ...
  // node_modules/cheerio/node_modules/entities/dist/esm/generated/decode-data-html.js
  init_shim();

  // node_modules/cheerio/node_modules/entities/dist/esm/internal/decode-shared.js
  init_shim();
  ...
  // node_modules/cheerio/node_modules/entities/dist/esm/generated/decode-data-xml.js
  init_shim();
  var xmlDecodeTree = /* @__PURE__ */ decodeBase64("AAJhZ2xxBwARABMAFQBtAg0AAAAAAA8AcAAmYG8AcwAnYHQAPmB0ADxg9SFvdCJg");

  // node_modules/cheerio/node_modules/entities/dist/esm/internal/bin-trie-flags.js
  init_shim();
  var BinTrieFlags2;
  (function(BinTrieFlags3) {
    BinTrieFlags3[BinTrieFlags3["VALUE_LENGTH"] = 49152] = "VALUE_LENGTH";
  ...
  var Tokenizer2 = class {
    ...
    stateBeforeTagName(c) {
      if (c === CharCodes4.ExclamationMark) {
        ...
        } else if (lower === Sequences2.TitleEnd[2]) {
    ...
    stateBeforeSpecialT(c) {
      const lower = c | 32;
      if (lower === Sequences2.TitleEnd[3]) {
        this.startSpecial(Sequences2.TitleEnd, 4);
      } else if (lower === Sequences2.TextareaEnd[3]) {
  ...
  var Parser2 = class {
    ...
    onattribend(quote, endIndex) {
      var _a4, _b;
      this.endIndex = endIndex;
      (_b = (_a4 = this.cbs).onattribute) === null || _b === void 0 ? void 0 : _b.call(_a4, this.attribname, this.attribvalue, quote === QuoteType2.Double ? '"' : quote === QuoteType2.Single ? "'" : quote === QuoteType2.NoValue ? void 0 : null);
      if (this.attribs && !Object.prototype.hasOwnProperty.call(this.attribs, this.attribname)) {
        this.attribs[this.attribname] = this.attribvalue;
      }
      this.attribvalue = "";
  ...
  function parseDOM(data2, options) {
    return parseDocument2(data2, options).children;
  }
  ...
  globalThis.__cheerio = slim_exports;
